          ...
          <div className="flex flex-wrap items-end justify-between gap-6">
            <div className="max-w-[44rem]">
              ...
              <p className="mt-6 max-w-[38rem] text-lg leading-relaxed text-muted">
                Community reports of enforcement activity in the last four hours, on a map. Report what you see, confirm what
                others saw, and keep your rights one scroll away. Kept separate from your money, by design.
              </p>
            </div>
          </div>
