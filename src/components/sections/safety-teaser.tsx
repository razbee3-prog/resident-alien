      ...
      <Container>
        <div className="panel grid gap-6 p-8 md:grid-cols-[1fr_auto] md:items-center md:p-10">
          <div>
            ...
            <p className="mt-2 max-w-[36rem] text-[1rem] text-muted">Reported immigration-enforcement activity on a U.S. map, your rights in plain language, and the hotlines that answer.</p>
          </div>
