...
export function Statement() {
  return (
    <section className="border-t border-hairline py-24 text-center md:py-32">
      <Container>
        <p className="num font-display text-[4rem] font-bold leading-none tracking-[-0.05em] sm:text-[6rem] md:text-[8rem]">350,000</p>
        ...
        <p className="mt-8 text-xs text-faint">New international students and arriving H-1B professionals, 2024/25.</p>
      </Container>
    </section>
  );
}
