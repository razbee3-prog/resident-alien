    ...
    <section className="border-t border-hairline py-20 md:py-24">
      <Container className="grid items-center gap-8 md:grid-cols-[auto_1fr] md:gap-16">
        ...
        <div className="max-w-[26rem]">
          <p className="text-xl leading-snug text-ink md:text-2xl">people start their U.S. financial life from zero every year.</p>
          <p className="mt-2 text-xl text-muted md:text-2xl">You don’t have to.</p>
        </div>
      </Container>
    </section>
  );
